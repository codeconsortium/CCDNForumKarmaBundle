			...
			->children()
				...
				->arrayNode('template')
					->children()
						...
						->scalarNode('theme')->defaultValue('CCDNForumKarmaBundle:Form:fields.html.twig')->end()
					->end()
				->end()
			->end();
			...
			->children()
				->arrayNode('rate')
					->children()
						->arrayNode('layout_templates')
							->children()
								->scalarNode('rate')->defaultValue('CCDNComponentCommonBundle:Layout:layout_body_left.html.twig')->end()
							->end()
						->end()
					->end()
				->end()
